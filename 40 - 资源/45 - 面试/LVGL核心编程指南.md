...
*   **X 轴**：向**右**增加为正，向**左**为负。
*   **Y 轴**：向**下**增加为正，向**上**为负。
![](../44%20-%20硬件/电路设计/images/LVGL核心编程指南/file-20260128155151553.jpg)
...
- **参数详解**：
    ...
    - `y_ofs`：偏移量。
- **返回值**：无。
![](../44%20-%20硬件/电路设计/images/LVGL核心编程指南/file-20260128155654900.jpg)
#### 快捷居中：`lv_obj_center`
- **函数原型**：
    ```c
...
![](../44%20-%20硬件/电路设计/images/LVGL核心编程指南/file-20260128160210242.jpg)
