# 嵌入式硬件：深入剖析 ADC 模数转换器 —— 连接模拟与数字世界的桥梁
...
#### (2) 注入通道组 (Injected Group) —— 紧急的“中断服务”
...
void adc_init(void) {
    ...
    ADC_CommonInitStructure.ADC_Prescaler = ADC_Prescaler_Div4; // 时钟分频，勿超 36MHz
